                   ...
                   ORBVocabulary *mVocabulary, KeyFrameDatabase *mKeyFrameDatabase) : mnBALocalForKFCand(0), mnBAFixedForKFCand(0), mnBALocalCount(0)
{
    ...
    fs["mnFrameId"] >> val_tmp;
    mnFrameId = (const unsigned long)val_tmp;
    ...
    fs["mnFuseTargetForKF"] >> val_tmp;
    mnFuseTargetForKF = (unsigned long)val_tmp;
    fs["mnBALocalForKF"] >> val_tmp;
    mnBALocalForKF = (unsigned long)val_tmp;
    fs["mnBAFixedForKF"] >> val_tmp;
    mnBAFixedForKF = (unsigned long)val_tmp;

    fs["mnLoopQuery"] >> val_tmp;
    mnLoopQuery = (unsigned long)val_tmp;
