...
# Result_root = '/mnt/DATA/tmp/EuRoC/GF_GGraph_Mono_preP_Speedx'
# Result_root = '/mnt/DATA/tmp/EuRoC/GF_SWF_Mono_preP_Speedx'
# Result_root = '/mnt/DATA/tmp/EuRoC/GF_Covis_Mono_preP_Speedx'
# Result_root = '/mnt/DATA/tmp/EuRoC/GF_BaseBA_Mono_preP_Speedx'

Result_root = '/mnt/DATA/tmp/EuRoC/GF_GGraph_Mono_Speedx'
# Result_root = '/mnt/DATA/tmp/EuRoC/GF_SWF_Mono_Speedx'
# Result_root = '/mnt/DATA/tmp/EuRoC/GF_Covis_Mono_Speedx'
# Result_root = '/mnt/DATA/tmp/EuRoC/GF_BaseBA_Mono_Speedx'
# Result_root = '/mnt/DATA/tmp/EuRoC/ORB_BaseBA_Mono_Speedx'
    ...
    for ri, num_gf in enumerate(Number_GF_List):
        ...
        for iteration in range(0, Num_Repeating):
            ...
            for sn, sname in enumerate(SeqNameList):
                ...
                # enable viz
                # cmd_slam   = str('../Examples/Monocular/mono_general ' \
